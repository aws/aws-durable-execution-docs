...
The [Powertools for AWS Lambda logger](#powertools-for-aws-lambda) is a drop-in
replacement for the Durable Execution SDK logger.
...
The following examples show logging from inside a step:
...
=== "TypeScript"
    ...
    export const handler = DurableHandler(async (context) => {
